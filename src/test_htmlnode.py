...
class TestLeafNode(unittest.TestCase):
    ...
    def test_print(self):
        node = LeafNode("p", "This is a paragraph", {"class": "paragraph"})
        self.assertEqual(repr(node), "LeafNode(p, This is a paragraph, {'class': 'paragraph'})")
...
class TestParentNode(unittest.TestCase):
    ...
    def test_print(self):
        node = ParentNode("div", [LeafNode("p", "This is a paragraph"), LeafNode("p", "This is another paragraph")], {"class": "container"})
        self.assertEqual(repr(node), "ParentNode(div, [LeafNode(p, This is a paragraph, None), LeafNode(p, This is another paragraph, None)], {'class': 'container'})")
